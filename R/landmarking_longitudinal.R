...
#'
#' @examples
setGeneric("fit_longitudinal_v2", function(x, landmarks, method, formula,...) standardGeneric("fit_longitudinal_v2"))
...
setMethod("fit_longitudinal_v2", "Landmarking", function(x, landmarks, method, formula,...) {
  ...
  if (length(landmarks) == 1) {
    ...
    # Recursion
    x <- fit_longitudinal_v2(x, landmarks[1], method, formula, ...)
    x <- fit_longitudinal_v2(x, landmarks[-1], method, formula, ...)
  }
  x
})
...
#'
#' @examples
setGeneric("predict_longitudinal_v2", function(x, landmarks, method, ...) standardGeneric("predict_longitudinal_v2"))
...
setMethod("predict_longitudinal_v2", "Landmarking", function(x, landmarks, method, ...) {
  ...
  if (length(landmarks) == 1) {
    ...
    # Recursion
    x <- predict_longitudinal_v2(x, landmarks[1], method, ...)
    x <- predict_longitudinal_v2(x, landmarks[-1], method, ...)
  }
  x
})
