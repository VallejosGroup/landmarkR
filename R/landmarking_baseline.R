### setClass("LandmarkingBaseline",
###   contains = "Landmarking"
### )
###
### LandmarkingBaseline <- function(landmarks, horizons, dataset, event_indicator, baseline_covariates, biomarkers, ids, event_time) {
###   new("LandmarkingBaseline",
###       landmarks = landmarks,
###       horizons = horizons,
###       dataset = dataset,
...
### }
###
### setMethod("survival_wrapper", "LandmarkingBaseline", function(x, landmark_index) {
