...
covariate, dose. This step is then followed by fitting Cox proportional hazards
sub-models using the longitudinal predictions as covariates.
...
Now we will use the `lcmm` package  to fit a latent class mixed model of the
time-varying covariate, `dose`. This step is followed by fitting a Cox PH
